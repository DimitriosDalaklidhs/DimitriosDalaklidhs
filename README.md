...
Final year Informatics student at the University of Western Macedonia (THE World University Rankings: Computer Science 601–800 for 2025), graduating July 2026. I work primarily in C and Java, with a focus on systems programming, network applications, and backend development. Comfortable at the low level: sockets, POSIX, process management, memory. Experienced building production grade backend services with REST APIs, JWT auth, role-based access control, and relational databases. Open - source contributor to ion fusion (Amazon). Open to roles in systems, backend, or software engineering.
&nbsp;
