...
Final year Informatics student at the University of Western Macedonia (THE World University Rankings: Computer Science 601-800 for 2025), graduating July 2026. I work primarily in C and Java with a focus on systems programming and backend development. Comfortable with sockets, POSIX, process management, memory. I also have experience building production-grade backend services with REST APIs, JWT auth, role based access control and relational databases. At the same time I am an open-source contributor to ion fusion (Amazon). Open to roles in systems, backend or software engineering.
&nbsp;
